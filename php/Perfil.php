               ...
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     <div class="modal-header">
                        <h5 class="modal-title w-100 text-center">Actualizar usuario</h5>
                     </div>
                     <div class="modal-body w-100">
                        <!-- Manejar la informacion que se manda de este formulario -->
                        <form class="w-100 needs-validation" method="post" novalidate>
                           <div class="form-group">
                              ...
                              <div class="invalid-feedback">Por favor, ingrese un nombre nuevo de usuario.</div>
                           </div>
                           <button type="submit" class="btn btn-primary btn1 mt-3 btn1">Cambiar nombre de usuario</button>
                        </form>
                     </div>
                  </div>
               </div>
